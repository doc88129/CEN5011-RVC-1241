...
CREATE TABLE `user_meal` (
  ...
  UNIQUE KEY `user_id` (`user_id`,`meal_id`),
  KEY `meal_id` (`meal_id`),
  CONSTRAINT `user_meal_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `user_meal_ibfk_2` FOREIGN KEY (`meal_id`) REFERENCES `meal` (`meal_id`)
...
INSERT INTO `user_meal` VALUES (1,10,1),(2,10,2);
